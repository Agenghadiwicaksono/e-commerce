        ...
        <div class="overflow-hidden shadow sm:rounded-md">
          <div class="px-4 py-5 bg-white sm:p-6">
            <form method="POST"
              ...
              <div class="mb-6">
                <label for="nama" class="block mb-2 text-sm">Nama Ticket</label>
                <input type="nama" name="nama" class="bg-gray-50 border border-gray-300 rounded-lg w-full p-2.5"
                       value="{{ isset($ticket) ? $ticket->nama : old('nama') }}">
              </div>
              <div class="mb-6">
